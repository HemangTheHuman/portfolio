      ...
      <DialogPortal>
        ...
        <DialogPrimitive.Content className="fixed inset-0 z-50 flex items-center justify-center p-4 md:p-6">
          <div className="relative w-full h-full max-w-[1400px] bg-slate-900 border border-slate-700 rounded-lg overflow-hidden flex flex-col">
            ...
            <DialogTitle className="sr-only">{experience.title} at {experience.company}</DialogTitle>
            <DialogDescription className="sr-only">{experience.description}</DialogDescription>
            ...
            <div className="overflow-y-auto flex-1">
              <div className="max-w-4xl mx-auto px-6 py-12 md:px-12 md:py-16">
                ...
                <div className="mb-8">
                  ...
                  {/* Title */}
                  <h1 className="text-white mb-6">{experience.title}</h1>
                  ...
                  {/* Technologies */}
                  {experience.detailedContent?.technologies && (
                    <div className="flex flex-wrap gap-2">
                      {experience.detailedContent.technologies.map((tech, index) => (
                        <Badge
                          key={index}
                          variant="secondary"
                ...
                {experience.detailedContent && (
                  <article className="prose prose-invert prose-lg max-w-none">
                    {experience.detailedContent.blogContent.map((paragraph, index) => {
                      ...
                      if (paragraph.startsWith('[IMAGE:') && paragraph.endsWith(']')) {
                        ...
                        const imageUrl = experience.detailedContent?.images?.[imageIndex];
                ...
                <div className="text-center text-gray-400 pb-8">
                  <p>Thanks for reading about my experience at {experience.company}!</p>
                </div>
              </div>
            </div>
          </div>
